...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        mVisualizerView.setMinSizeScale(Integer.parseInt(sharedPreferences.getString(getString(R.string.pref_shape_size_key),
                getResources().getString(R.string.pref_shape_size_default_value))));
