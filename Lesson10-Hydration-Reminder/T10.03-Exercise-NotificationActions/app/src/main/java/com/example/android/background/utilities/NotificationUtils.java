...
public class NotificationUtils {
    ...
    private static final int DISMISS_REMINDER_PENDING_INTENT_ID = 1234;
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getService(
                context,
                DISMISS_REMINDER_PENDING_INTENT_ID,
                intent,
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        return new NotificationCompat.Action(
                ...
                context.getString(R.string.increment_water_action_title),
                pendingIntent
        );
    }
