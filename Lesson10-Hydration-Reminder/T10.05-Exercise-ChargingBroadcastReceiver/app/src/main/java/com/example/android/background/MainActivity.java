...
public class MainActivity extends AppCompatActivity implements
    ...
    private final ChargingBroadcastReceiver broadcastReceiver = new ChargingBroadcastReceiver();
    ...
    public void showCharging(boolean isCharging) {
        int imageId = R.drawable.ic_power_grey_80px;
        if (isCharging) {
            imageId = R.drawable.ic_power_pink_80px;
        }

        mChargingImageView.setImageDrawable(getDrawable(imageId));
    }
